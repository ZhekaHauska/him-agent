...
from dhtm.experiments.successor_representations.runners.base import BaseEnvironment
import os
import numpy as np
from dhtm.common.config.base import read_config
import io
...
class GridWorldWrapper(BaseEnvironment):
    ...
    def _start_env(self, setup):
        from dhtm.envs.gridworld import GridWorld
        config = read_config(
            self._get_setup_path(setup)
        )

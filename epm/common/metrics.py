...
from epm.agents.episodic_control.agent import ECAgent, euclidian_sim, cosine_similarity
from epm.common.lazy_imports import lazy_import
from typing import Dict, Literal, Optional

from epm.common.sdr import sparse_to_dense
from epm.modules.belief.utils import normalize
...
class GridworldSR(BaseMetric):
    def __init__(
        ...
        from epm.agents.succesor_representations.striatum import Striatum
